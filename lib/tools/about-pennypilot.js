...
export const aboutPennypilotSchema = {
  ...
  description: `Présente PennyPilot et ses 13 outils à l'utilisateur. Retourne une carte d'accueil structurée en français.
...
Je suis **PennyPilot v0.2.4**, le copilote IA de votre cabinet sur Pennylane. Je couvre la production de la note client, la lecture financière, et le cœur du métier comptable (Grand livre, journaux, lettrage, audit).

## 🆕 v0.2.4 — Deux changements importants

...
export const aboutPennypilotSchema = {
  ...
  description: `Présente PennyPilot, ses 13 outils comptables read-only et ses 3 outils d'aide à l'installation. Retourne une carte d'accueil structurée en français.
